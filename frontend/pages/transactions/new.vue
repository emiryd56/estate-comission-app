  ...
  <div class="mx-auto max-w-2xl">
    <header class="mb-6">
      ...
      <p class="mt-1 text-sm text-slate-500">
        İlan ve satış ajanlarını seçerek yeni bir komisyon süreci başlatın.
      </p>
    </header>
    ...
    >
      ...
      >
        Henüz ajan yok. Önce
        <NuxtLink to="/users" class="font-semibold underline">Kullanıcılar</NuxtLink>
        sayfasından bir ajan ekleyin.
      </div>
